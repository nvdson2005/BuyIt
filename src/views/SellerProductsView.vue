...
// Khi có API: xác định lại product
  ...
  <div class="space-y-4">
    <div class="flex items-center justify-between">
      ...
      <div class="flex gap-2">
        <button class="inline-flex items-center px-3 py-2 whitespace-nowrap rounded-md text-sm font-medium transition-all border border-gray-200 w-full h-10 justify-between bg-background text-foreground text-gray-700 hover:bg-gray-200 border-gray-300">
          Công cụ xử lý hàng loạt
        </button>
        <button @click="onAddNewProduct" class="inline-flex text-white items-center px-3 py-2 whitespace-nowrap rounded-md text-sm font-medium transition-all border border-gray-200 bg-[#ee4d2d] hover:bg-[#d73211]">
          + Thêm 1 sản phẩm mới
        </button>
      </div>
    </div>
    ...
    <div class="bg-white p-4 rounded-lg shadow-sm space-y-4">
      ...
      <div class="flex justify-start gap-2">
        <button class="inline-flex items-center px-3 py-2 whitespace-nowrap rounded-md text-white text-sm font-medium transition-all border border-gray-200 h-10 bg-[#ee4d2d] hover:bg-[#d73211]">
          Áp dụng
        </button>
          <button class="inline-flex items-center px-3 py-2 whitespace-nowrap rounded-md text-sm font-medium transition-all border border-gray-200 h-10 justify-between bg-background text-foreground text-gray-700 hover:bg-gray-200 border-gray-300">
            Nhập Lại
          </button>
      </div>
    </div>
          ...
          <TableRow v-for="product in products" :key="product.id">
            ...
            <TableCell>
              <div class="flex flex-col items-start">
                <button class="inline-flex items-center gap-2 rounded-md text-sm text-red-600 transition-all focus-visible:ring-[3px] text-primary underline-offset-4 hover:underline p-0 h-auto">
                  Cập nhật
                </button>
                <button class="inline-flex items-center gap-2 rounded-md text-sm text-red-600 transition-all focus-visible:ring-[3px] text-primary underline-offset-4 hover:underline p-0 h-auto">
                  Quảng cáo
