...
<template>
  ...
  <div
    class="bg-white mt-20 rounded-lg w-full max-w-3xl p-6
  ...
  >
    ...
    <div class="flex gap-8">
      ...
      <div class="w-80 flex flex-col items-center border-l pl-8">
        ...
        <UploadImageButton v-if="isEditingProfile" v-model="profile.image_url"></UploadImageButton>
        <CustomImage v-else :src="profile.image_url" class="w-full h-32 object-cover rounded"></CustomImage>
        </div>
    </div>
